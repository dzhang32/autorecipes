...
Below is a basic illustration of how to use `autorecipes`. For a more comprehensive overview, please read the [vignette](https://dzhang32.github.io/autorecipes/articles/autorecipes.html). 
